...
import FresherDashboardPlan from "../components/FresherDashboard";
import FresherPlacementDetailsFourthStep from "../components/FresherPlacementDetails_4step";
...
import FresherJobFair from "../components/FresherJobFair";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          exact
          element={<FresherDashboardPlan />}
        />
        <Route
          path="fresher-placement-job-fair"
          exact
          element={<FresherJobFair />}
        />
        <Route
        ...
        <Route
          ...
          element={<FresherPlacementDetailsFourthStep />}
        />
        <Route
        ...
        />
        {/* <Route
          path="fresher-placement-details-fourth-step"
          exact
          element={<FresherPlacementDetailsFourthStep />}
        /> */}
