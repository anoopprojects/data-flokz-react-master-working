          ...
          <div className="instant-skill-container">
            <div className="Instant-placement-container">
              <img
                ...
                src={instantActive ? instantPlacementActive : instantPlacement}
                alt="instant placement"
              />
            </div>
            <div className="Skill-placement-container">
              <img
                onClick={() => setInstantActive(false)}
                src={instantActive ? skillPlacement : skillPlacementActive}
                alt="skill-placement"
              />
            </div>
          </div>
