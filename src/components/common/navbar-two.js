...
import img1 from "../img/new-updated-logo.png";
            ...
            >
              ...
              <div className="navbar-right d-flex align-items-center">
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item has-dropdown">
                    <a href="#" className="nav-link navbar_two_dbset">
                      <img
                        src={ProfileImageBucket + profile_image}
                        alt=""
                        className=""
                      />{" "}
                      &nbsp;
                ...
                <div className="dashboard-profile-div five_show">
                  <a href="">
                    <img src={ProfileImageBucket + profile_image} alt="" />
                  </a>
                </div>
              </div>
            </div>
