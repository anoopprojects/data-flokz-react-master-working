      ...
      <section>
        ...
        <div className="placement_details_instruction_first_step_container">
          ...
          <div style={{ margin: "20px" }}>
            <h2 className="placement_details_interview_content_title">
              An interview is a two-way process. The company is evaluating your
              suitability for the job, and you are evaluating the company as a
              potential employer. Keep these instructions in mind to ace your
              interview and secure your dream job.
            </h2>
            <h3 className="placement_details_interview_content_subtitle">
              Instructions for the Interview:
            </h3>
            <ol className="placement_details_interview_ordered_list">
              <li>
                Dress professionally and according to the company's culture and
                dress code.
              </li>
              <li>
                Be punctual for the interview, whether in-person or virtual.
              </li>
              <li>
                Bring copies of relevant documents and be prepared to answer
                questions about your qualifications and achievements.
              </li>
              <li>
                Speak confidently and highlight your strengths while maintaining
                eye contact.
              </li>
              <li>
                Send a thank-you email or message after the interview to show
                your appreciation and enthusiasm for the opportunity.
              </li>
            </ol>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <input
                type="checkbox"
                name="checkBoxInterview"
                id="checkBoxInterview"
              />
              <p htmlFor="checkBoxInterview" className="checkbox_after_content">
