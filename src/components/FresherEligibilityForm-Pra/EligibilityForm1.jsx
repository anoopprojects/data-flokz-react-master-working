  ...
  return (
    <div className="eligibility_container_data">
      ...
      <div className="fresher_eligibility_flex_for_image_container">
        <div
          className="fresher_eligibility_flex_left_panel"
          style={{ width: "28%" }}
        >
          <h1 className="eligibility_candidate_opted">
            Candidated who <br />
            opted this plan
          </h1>
        ...
        <section
          style={{ width: "70%" }}
          className="eligibility-form-container"
        >
            ...
            >
              ...
              >
                ...
                <label
                  ...
                  className="eligibility-form-upload-document-container"
                >
