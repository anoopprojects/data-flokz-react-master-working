  ...
  function MyVerticallyCenteredModal(props) {
    return (
      ...
      >
        ...
        {}
        <Modal.Body
          style={{ padding: "20px 50px", height: "50vh", overflow: "scroll" }}
        >
          <div>
            <h1
              className="c22 c19 c33"
              id="h.2pqi16pbimlh"
              style={{
                color: "#000000",
                fontSize: "20pt",
            ...
            >
              <span className="c7" style={{ fontSize: "12pt" }}>
                This Income Share Agreement ("ISA" or "Agreement") is between:
                Student , (hereinafter referred to as the{" "}
              </span>
              <span
                className="c8 c7"
                style={{ fontWeight: 700, fontSize: "12pt" }}
              >
                "Student", "Trainee", "You", or "Your
              </span>
              <span
                className="c3"
                style={{
              ...
              >
                ", and which expression shall mean and includes the legal heirs,
                executors and administrators of the student) of the ONE PART;
              </span>
            </p>
            <p
              className="c20 c19"
            ...
            >
              ...
              >
                &nbsp;duly incorporated under Data Folkz Private Limited, under
                the Indian Law of Governance (hereinafter -“the Institution
                (Salaryfy*)”), as the Placement provider.
              </span>
            </p>
            <p
              className="c12 c22 c26"
              style={{
                margin: 0,
                color: "#000000",
                fontSize: "11pt",
            ...
            <ol
              className="c6 lst-kix_6pbphlkze45l-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_6pbphlkze45l-0 0",
              }}
            >
              <li
                className="c14 c5 c27 li-bullet-0"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
                  ...
                  paddingLeft: "0pt",
                  marginLeft: "36pt",
                  counterIncrement: "lst-ctn-kix_6pbphlkze45l-0",
                }}
              >
                <span
                  className="c13 c8 c7"
            ...
            <ol
              className="c6 lst-kix_c54j4idzqx9-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_c54j4idzqx9-0 0",
              }}
            >
              <li
                className="c2 c18 li-bullet-1"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
                  ...
                  marginLeft: "46pt",
                  paddingLeft: "3.6pt",
                  counterIncrement: "lst-ctn-kix_c54j4idzqx9-0",
                }}
              >
                <span
                  className="c3"
            ...
            <ul
              className="c6 lst-kix_q5k350rrfndu-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c2 c19 c5 c28 li-bullet-0"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
              ...
              >
                ...
                >
                  ...
                  received or deemed earned by You, directly or indirectly, such
                  as contributions to qualified and non-qualified deferred
                  compensation and retirement benefit plans, fringe benefits not
                  reported as wages for compensation, income and distributions
                  from Your active participation in any entity, and equity
                  rights or deferred compensation generated or attributable to
                  the current period of Your employment.
                </span>
              </li>
              <li
                className="c2 c19 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  Moreover, Earned Income includes any amounts earned or payable
                  to You, directly or indirectly, as a result of Your provision
                  of services to a related party.
                </span>
              </li>
              <li
                className="c2 c19 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  The Institution (Salaryfy*) may estimate Your Earned Income
                  using documentation other than Your income tax return at its
                  discretion, provided that the documentation is from another
                  verifiable source acceptable to the Institution.
                </span>
              </li>
              <li
                className="c2 c19 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  ...
                  skill developed through Training) shall be determined by the
                  Institution (Salaryfy*) at its sole discretion and such
                  determination shall be binding on You.
                </span>
              </li>
            </ul>
            <ol
              className="c6 lst-kix_c54j4idzqx9-0"
              start={2}
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c2 c18 li-bullet-2"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
              ...
              >
                ...
                >
                  &nbsp;refers to the period commencing upon Your Earned Income
                  during which period You have an obligation to make Monthly
                  Payments/ ISA threshold amount to the Institution (Salaryfy*),
            ...
            <ol
              className="c6 lst-kix_2xtp79rvj4zh-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_2xtp79rvj4zh-0 0",
              }}
            >
              <li
                className="c14 c5 c27 li-bullet-0"
                style={{
                  ...
                  paddingLeft: "0pt",
                  marginLeft: "36pt",
                  counterIncrement: "lst-ctn-kix_2xtp79rvj4zh-0",
                }}
              >
                <span
                  className="c3"
            ...
            >
              <span className="c7" style={{ fontSize: "12pt" }}>
                ...
                threshold ISA payment to the institution (Salaryfy*). As per the
                terms of this agreement, you shall pay the Institution
                (Salaryfy*) 12% of your yearly income by an NBFC or credit card
                within 30 days of the start date of employment.
              </span>
            </p>
            <ol
              className="c6 lst-kix_2xtp79rvj4zh-0"
              start={2}
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
            ...
            >
              ...
              >
                ...
                unless the bank account where the payments are made is the same
                as the one where your earned income is received.
              </span>
            </p>
            <p
              className="c1 c27"
            ...
            <ol
              className="c6 lst-kix_cfbk03o8i2z7-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_cfbk03o8i2z7-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_cfbk03o8i2z7-0",
                }}
              >
                <span
                  className="c3"
            ...
            <ol
              className="c6 lst-kix_zegiv1y46upy-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_zegiv1y46upy-0 0",
              }}
            >
              <li
                className="c14 c5 c27 li-bullet-0"
                style={{
                  ...
                  paddingLeft: "0pt",
                  marginLeft: "36pt",
                  counterIncrement: "lst-ctn-kix_zegiv1y46upy-0",
                }}
              >
                <span
                  className="c3"
              ...
              >
                ...
                >
                  : In order to guarantee a 100% placement through this
                  programme, the student hereby consents to the following terms.
                </span>
              </li>
            </ol>
            <ol
              className="c6 lst-kix_zegiv1y46upy-1 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_zegiv1y46upy-1 0",
              }}
            >
              <li
                className="c2 c19 c5 c28 li-bullet-0"
                style={{
                  ...
                  paddingLeft: "0pt",
                  marginLeft: "72pt",
                  counterIncrement: "lst-ctn-kix_zegiv1y46upy-1",
                }}
              >
                <span
                  className="c3"
              ...
              >
                ...
                >
                  The student is required to complete all of the assignments and
              ...
              >
                ...
                >
                  The student must receive a score of at least 75% on each of
                  the terminal exams.
                </span>
              </li>
              <li
              ...
              >
                ...
                >
                  The course completion exam must be passed with a score of at
                  least 75%.
                </span>
              </li>
            </ol>
            <ol
              className="c6 lst-kix_zegiv1y46upy-0"
              start={9}
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
              ...
              >
                ...
                >
                  Your Obligations in Relation to Securing a Job Offer
                </span>
                <span className="c7" style={{ fontSize: "12pt" }}>
                  :{" "}
                </span>
              ...
              >
                ...
                >
                  ...
                  (Salaryfy*) shall &nbsp;apply for roles that are suited to
                  Your level of experience and areas of expertise and as will be
            ...
            >
              ...
              >
                MAKING PAYMENTS FROM EARNED INCOME
              </span>
            </p>
            <ol
              className="c6 lst-kix_bs9u26doid67-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_bs9u26doid67-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_bs9u26doid67-0",
                }}
              >
                <span
                  className="c3"
              ...
              >
                ...
                >
                  from your own income shall still be continued on the same
                  amount till you complete your payment term.
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  Default in payment of the Monthly Payments{" "}
                </span>
                <span
                  className="c3"
                  style={{
                ...
                >
                  – in the event of a delay in making payment of the Monthly
                  Payment, of more than 30 (thirty) days beyond the Payment Due
                  Date (“Payment Default”), the Institution (Salaryfy*) shall be
                  entitled to initiate legal actions for recovery of the amounts
                  due and payable to the Institution (Salaryfy*).
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  Student Exit Policy: (Voluntarily)
                </span>
              </li>
            </ol>
            <ul
              className="c6 lst-kix_216muxsppp1o-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c14 c5 c28 li-bullet-0"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
              ...
              >
                ...
                >
                  ...
                  Program if he: willingly quits the programme within 7 days of
                  the batch's start date.
                </span>
              </li>
              <li
                className="c14 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  However, if You decide to drop off / Withdraw anytime after
                  one week of the Course Training and the Placement Process, You
                  shall pay to the Institution (Salaryfy*):
                </span>
              </li>
            </ul>
            <a id="t.22b9da5a5a2e4d8510d38679ba0c5c59d03aa03b" />
            <a id="t.0" />
            <table
              className="c27 c35"
              style={{
            ...
            <ul
              className="c6 lst-kix_ypuy7rxpyiqc-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c14 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  ...
                  eligible to receive a NASSCOM Certificate after completing the
                  first 5 TERMS by paying an amount of Rs. 1000 to the
            ...
            <ol
              className="c6 lst-kix_bs9u26doid67-0"
              start={7}
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
              ...
              >
                ...
                >
                  Student Exit Policy: (Performance Based):{" "}
                </span>
                <span
                  className="c3"
                  style={{
                ...
                >
                  The student may also opt out of the 100% Employment Guarantee
                  Program if he is unable to satisfy any of these conditions:
                </span>
              </li>
            </ol>
            <ul
              className="c6 lst-kix_y867gnjkiug7-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c14 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  Even after two attempts, the student is unable to achieve a
                  score of more than 75% on any of the Terminal exams.
                </span>
              </li>
              <li
                className="c14 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  In addition, for a fee of Rs.1000, the student can obtain a
                  NASSCOM Certificate for the specific term.
                </span>
              </li>
              <li
                className="c14 c5 c28 li-bullet-0"
              ...
              >
                ...
                >
                  However, in any of the instances stated above, the security
                  deposit will not be reimbursed to the students.
                </span>
              </li>
            </ul>
            <p
            ...
            >
              ...
              >
                &nbsp;Reporting of all Earned Income
              </span>
              <span
                className="c0"
                style={{
            ...
            <ul
              className="c6 lst-kix_ew3wq0xtm0bp-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c2 c19 c5 c29 li-bullet-0"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
              ...
              >
                ...
                >
                  ...
                  description of the business and products or services provided
                  by each Employer and the nature of Your position with each
                  Employer;
                </span>
              </li>
              <li
              ...
              >
                ...
                >
                  ...
                  changes in Your Earned Income within thirty (30) days of any
                  event giving rise to such Change.
                </span>
              </li>
            </ul>
            <p
            ...
            >
              ...
              >
                Deposit of all Earned Income into Bank Account
              </span>
              <span
                className="c7 c8"
                style={{ fontWeight: 700, fontSize: "12pt" }}
            ...
            <ol
              className="c6 lst-kix_972768ct3vf0-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_972768ct3vf0-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_972768ct3vf0-0",
                }}
              >
                <span
                  className="c3"
            ...
            >
              ...
              >
                ...
                to make Monthly Payments from Earned Income. However, it does
                not terminate this ISA or any continuing obligations You may
                have to the Institution (Salaryfy*) to this Agreement, including
                but not limited to the obligation to make an additional payment
                if the Institution (Salaryfy*) determines that You underreported
                Your Earned Income.
              </span>
            </p>
            <p
            ...
            >
              ...
              >
                Confirmation of Earned Income and Employment:
              </span>
            </p>
            <p
              className="c2 c4"
            ...
            >
              ...
              >
                &nbsp;Under-reported Earned Income:
              </span>
            </p>
            <ol
              className="c6 lst-kix_vrh48nksrnco-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_vrh48nksrnco-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_vrh48nksrnco-0",
                }}
              >
                <span
                  className="c3"
                ...
                >
                  ...
                  Monthly Payment, in its discretion, by &nbsp;increasing Your
                  Income Share as the new CTC.
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  ...
                  underreported Your Earned Income at any time
                </span>
              </li>
            </ol>
            <p
            ...
            >
              ...
              >
                during the Payment Term so that You made one or lower Monthly
                Payments than Institution (Salaryfy*) is entitled to receive
                under this Agreement, Institution (Salaryfy*) shall give You
                notice within 15 (fifteen) days of completion of the
                Reconciliation of the amount of the underpayment and reasonable
                documentation of the underpayment calculation. You agree to pay
                the Institution (Salaryfy*) the aggregate amount of the
                underpayment within thirty (30) days of receiving such notice.
                The Institution (Salaryfy*) shall also be entitled to sweep from
                your designated bank account the amounts payable by You pursuant
                to this Clause.
              </span>
            </p>
            <p
            ...
            >
              ...
              >
                ...
                Institution (Salaryfy*) by paying an
              </span>
            </p>
            <p
              className="c14 c32"
            ...
            >
              ...
              >
                amount equal to the Prepayment Amount which is a fixed
                percentage of your CTC.
              </span>
            </p>
            <p
              className="c10"
            ...
            <ol
              className="c6 lst-kix_t7gzcatasl0g-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_t7gzcatasl0g-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_t7gzcatasl0g-0",
                }}
              >
                <span
                  className="c3"
              ...
              >
                ...
                >
                  Waiver of ISA Due to Death or Total Disability: &nbsp;We will
                  waive what You owe under this Agreement, including any past
                  due amounts and fees, in the case of any unfortunate event
                  leading to death or permanent total disability; if You would
                  like to assert a waiver based on disability, You will need to
                  provide documentation showing that You have been found to be
            ...
            <ol
              className="c6 lst-kix_qbphcycjw1qb-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_qbphcycjw1qb-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_qbphcycjw1qb-0",
                }}
              >
                <span
                  className="c3"
              ...
              >
                <span className="c7" style={{ fontSize: "12pt" }}>
                  That you abide by the Student Exit Policies (
                </span>
                <span className="c7" style={{ fontSize: "12pt" }}>
                  Voluntarily an
                </span>
                ...
                >
                  d Performance based) stated above in clause 4(H) and 4(G)
                  respectively.
                </span>
              </li>
              <li
            ...
            >
              ...
              >
                ...
                shall be valid and binding till an &nbsp;amount equal to the
                Income Share has been repaid by You in the manner as set out in
                this
              </span>
            </p>
            <p
              className="c2 c19 c32"
              style={{
                margin: 0,
                color: "#000000",
                fontSize: "11pt",
            ...
            <ol
              className="c6 lst-kix_i17r0smwciux-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_i17r0smwciux-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_i17r0smwciux-0",
                }}
              >
                <span
                  className="c3"
            ...
            <ul
              className="c6 lst-kix_cugx3zpjpppv-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c2 c19 c5 c23 li-bullet-0"
                style={{
                  color: "#000000",
                  fontSize: "11pt",
                  fontFamily: '"Arial"',
              ...
              >
                ...
                >
                  ...
                  such amount and related fees (including any rights available
                  to Institution (Salaryfy*) to garnish wages or set off any tax
                  refund and to sweep from your designated bank account the
                  amounts payable by You to the Institution (Salaryfy*)); or
                </span>
              </li>
              <li
                className="c2 c19 c5 c23 li-bullet-0"
            ...
            <ol
              className="c6 lst-kix_i17r0smwciux-0"
              start={2}
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
            ...
            <ol
              className="c6 lst-kix_pi6nngy40eey-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_pi6nngy40eey-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_pi6nngy40eey-0",
                }}
              >
                <span
                  className="c3"
            ...
            <ol
              className="c6 lst-kix_9k8pwkibb4ko-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_9k8pwkibb4ko-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_9k8pwkibb4ko-0",
                }}
              >
                <span
                  className="c3"
            ...
            <ol
              className="c6 lst-kix_ttrfm9wxskse-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_ttrfm9wxskse-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_ttrfm9wxskse-0",
                }}
              >
                <span
                  className="c3"
            ...
            >
              ...
              >
                VERIFICATION OF REVIEW AND INDEPENDENT DECISION TO ENTER INTO
                ISA:
              </span>
            </p>
            <p
            ...
            <ol
              className="c6 lst-kix_kecwxm3fxpwm-0 start"
              start={1}
              style={{
                padding: 0,
                margin: 0,
                listStyleType: "none",
                counterReset: "lst-ctn-kix_kecwxm3fxpwm-0 0",
              }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
                style={{
                  ...
                  marginLeft: "36pt",
                  paddingLeft: "0pt",
                  counterIncrement: "lst-ctn-kix_kecwxm3fxpwm-0",
                }}
              >
                <span
                  className="c3"
            ...
            >
              ...
              >
                22. Student Consent Form:
              </span>
            </p>
            <ul
              className="c6 lst-kix_svv9qqa3qs4-0 start"
              style={{ padding: 0, margin: 0, listStyleType: "none" }}
            >
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  I will give 80% or more attendance during the course duration
                  which is to delivered online.
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  I will never indulge in any kind of unethical practice
                  (Sharing code etc.)
                </span>
              </li>
              <li
              ...
              >
                ...
                >
                  I plan to work full time immediately after completing the
                  course.
                </span>
              </li>
              <li
              ...
              >
                ...
                >
                  I understand after successfully completing all the TERMS with
                  a score above than &nbsp;75% and availing a job, I will pay
                  12% from the annual package to the institution as the ISA
                  amount.
                </span>
              </li>
              <li
              ...
              >
                ...
                >
                  I understand that if I successfully complete all the TERMS
                  with a score below 75%, I will pay 10% from the annual package
                  to the institution as the ISA amount.
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  ...
                  third-party/ through college within the 6 months from the
                  course completion , I will still be liable to pay 10% of my
                  annual package to the institution.
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  I am aware that documents collected are for verification
                  purposes and
                </span>
              </li>
              <li
              ...
              >
                ...
                >
                  I authorize Data Folkz to keep my KYC related documents with
                  NBFC partners to process my application.
                </span>
              </li>
              <li
                className="c2 c4 c5 li-bullet-0"
              ...
              >
                ...
                >
                  I am responsible to any Forgery or falsification of any
                  document is a serious offence under Section 465 of the Indian
                  Penal Code of 1860.
                </span>
              </li>
            </ul>
            ...
            <a id="t.263e8daa63f9844e66afc360503fb56f300cff6e" />
            <a id="t.1" />
            <table
              className="c34"
              style={{
        ...
        <div className="form-check" style={{ paddingLeft: "40px" }}>
          ...
          <label className="form-check-label" htmlFor="invalidCheck2">
            I acknowledged that I have carefully read all the terms and
            conditions as mentioned in the <br />
            above document.
          </label>
        </div>
